        ...
        <v-col cols="3">
          <div id="page1">
            ...
            <v-card outlined style="height: 350px">
              ...
              <v-divider></v-divider>
              <v-card-text>
                <span class="headline">Level-3</span>
...
export default {
  ...
  methods: {
    ...
    deleted() {
      var send_info = {
        variable: 1,
        id: this.delete_list.id,
        name: this.delete_list.name,
        c_id: this.delete_list.c_id,
        level: this.delete_list.level,
      };
      console.log(send_info);
      const path = this.$api + "/product_category_api";
      axios
